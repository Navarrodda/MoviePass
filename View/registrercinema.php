          ...
          <div class="row">
            <div class="col-md-12 marcform">
             <form class="form1" method="post" action="<?php echo URL ?>/cinema/add/">
              ...
              <p class="p2" type="Capacity:"><input class="int" name="capacity" style="color:white" placeholder="It introduces the totality of the cinema in total numbers.."></input></p>
              ...
              <p class="p2" type="Input Value:"><input class="int" name="input_value" style="color:white" placeholder="What would you like to tell us.."></input></p>
